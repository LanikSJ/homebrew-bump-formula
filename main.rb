  ...
  if user_name.blank? && user_email.blank?
    ...
    begin
      ...
      odie <<~EOS
        ...
        If you are using the default GITHUB_TOKEN, please note that it does not work with the GitHub API's '/user' endpoint.
        You can avoid this by providing 'user_name' and 'user_email' inputs to the Action.
      EOS
    end
  end
